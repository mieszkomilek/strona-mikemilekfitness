...
def build():
 ...
 dest.mkdir()
 for name in ['index.html','kontakt.html','partnerzy.html','warunki.html','zwroty.html','styles.css','mobile-home.css','video.css','social.css','robots.txt','sitemap.xml','manifest.webmanifest','version.txt','.nojekyll']:shutil.copy2(R/name,dest/name)
