...
Aktualizacja domeny: `mikemilekfitness.com` jest zarządzana z poziomu Shopify (Domeny → Ustawienia DNS). Użytkownik ustawił rekord A na `185.199.108.153` oraz CNAME `www` na `mieszkomilek.github.io`; rekordy pocztowe MX/TXT pozostały bez zmian. Panel Shopify i jego serwery nazw pozostają operatorem DNS.
